...
const DEFAULT_BEHIND_GRADIENT =
  'radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(330,100%,50%,calc(var(--card-opacity)*0.12)) 4%,hsla(330,80%,45%,calc(var(--card-opacity)*0.10)) 10%,hsla(330,60%,40%,calc(var(--card-opacity)*0.08)) 50%,hsla(330,0%,30%,0) 100%),radial-gradient(35% 52% at 55% 20%,rgba(255,0,110,0.08) 0%,rgba(255,0,110,0) 100%),radial-gradient(100% 100% at 50% 50%,rgba(255,0,110,0.10) 1%,rgba(255,0,110,0) 76%),conic-gradient(from 124deg at 50% 50%,rgba(255,0,110,0.12) 0%,rgba(255,0,110,0.08) 40%,rgba(255,0,110,0.08) 60%,rgba(255,0,110,0.12) 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  iconUrl = 'https://assets.codepen.io/13471/holo-sparkles.webp',
  grainUrl = 'https://assets.codepen.io/13471/sparkles.gif',
  behindGradient,
  innerGradient,
